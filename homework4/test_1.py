...
with open(r'conftest.py') as f:
    testdata = yaml.safe_load(f)

with open(r'/Users/ulialatynnikova/Desktop/Web_testing/homework4/config.yaml') as f:
...
def test_api_check_post_title(auth_token, send_email):
    try:
        ...
        res_get = requests.get(url=data['url2'], headers={"X-Auth-Token": auth_token},
                               params={"owner": "notMe"})
